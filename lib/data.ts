...
export const featuredProjects = [
  ...
  },
  {
    ...
    category: "Backend",
    status: "LIVE" as const,
    demo: "https://flags.codennomad.com/docs",
    github: "https://github.com/codennomad/feature-flags",
    stars: 0,
    language: "Python",
    metric: "<1ms eval",
  },
  {
    ...
    category: "Backend",
    status: "LIVE" as const,
    demo: "https://aegis.codennomad.com/docs",
  ...
  },
  {
    ...
    description:
      "Real-time financial intelligence dashboard. Tracks insider trades (SEC Form 4), congressional STOCK Act disclosures, options flow, and dark pool prints. Live data pipeline via Celery beat + SEC EDGAR RSS with WebSocket push to the UI.",
    stack: ["Python", "FastAPI", "React", "TypeScript", "Celery", "Redis", "PostgreSQL", "WebSocket"],
    category: "Backend",
    status: "LIVE" as const,
    demo: "https://smartmoney.codennomad.com",
    github: "https://github.com/codennomad/smart-money-tracker",
    stars: 0,
    language: "Python",
    metric: "live SEC feed",
  },
  {
    slug: "scryll",
    name: "Scryll",
    ...
    category: "Backend",
    status: "LIVE" as const,
    demo: "https://scryll.codennomad.com",
